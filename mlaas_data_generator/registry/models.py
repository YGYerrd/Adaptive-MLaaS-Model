...
def _registry_entry(
    ...
    **extra: object,
    ...
    spec: ModelSpec = {
        ...
        "allowed_run_regimes": list(allowed_run_regimes),
...
def _text_classification_model(
    ...
    *,
    ...
    return _registry_entry(
        ...
        allowed_run_regimes=allowed_run_regimes,
    )
...
TEXT_CLASSIFICATION_MODELS: tuple[RegistryEntry, ...] = (
    _text_classification_model(
        ...
        allowed_run_regimes=FINETUNE_AND_INFERENCE,
    ),
    _text_classification_model(
    ...
    _text_classification_model(
        ...
        allowed_run_regimes=FINETUNE_ONLY,
    ),
    _text_classification_model(
